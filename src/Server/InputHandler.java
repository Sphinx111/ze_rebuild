...
public class InputHandler {
    ...
    public void keyInCheck() {
        ...
        if (pApp.key == 'W' || pApp.key == 'w') {
            ...
            pApp.stateManager.gameManager.mapHandler.editor.setCurrentEditorMode(enums.EntityType.FIXED);
        } else if (pApp.key == '2') {
            pApp.stateManager.gameManager.mapHandler.editor.setCurrentEditorMode(enums.EntityType.SENSOR);
        } else if (pApp.key == '3') {
        pApp.stateManager.gameManager.mapHandler.editor.setCurrentEditorMode(enums.EntityType.GAME_LOGIC);
        } else if (pApp.key == '4') {
            pApp.stateManager.gameManager.mapHandler.editor.setCurrentEditorMode(enums.EntityType.DOOR);
        } else if (pApp.key == 'o' || pApp.key == 'O') {
            pApp.stateManager.gameManager.mapHandler.saveMap();
        } else if (pApp.key == 'l' || pApp.key == 'L') {
            pApp.stateManager.gameManager.mapHandler.loadMap();
        }
